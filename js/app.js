...
new Swiper('.swiper-container.mobile-slider__row_top', {
	// Стрелки
	navigation: {
		nextEl: '.mobile-slider__button_next',
		prevEl: '.mobile-slider__button_prev'
	},
	// Навигация
	// Буллеты, текущее положение, прогрессбар
	pagination: {
		...
		type: 'bullets',
		clickable: true,
		bulletClass: "mobile-slider__bullet",
		bulletActiveClass: "mobile-slider__bullet_active",
	},
	speed: 800,
});

new Swiper('.swiper-container.mobile-slider__row_bottom', {
	// Стрелки
	navigation: {
		nextEl: '.mobile-slider__button_next',
		prevEl: '.mobile-slider__button_prev'
...
new Swiper('.swiper-container.trademark-slider__container', {
	// Количество слайдов для показа
	slidesPerView: 1,
	...
	// Стрелки
	navigation: {
		nextEl: '.trademark-slider__button_next',
		prevEl: '.trademark-slider__button_prev'
	},
	// Скорость
	speed: 1100,
...
window.onclick = function (event) {
	if (!event.target.matches('.lang-select__dropButton')) {

		var dropdowns = document.getElementsByClassName("lang-select__list");
		var i;
...
$(document).ready(function () {
	$('.burger-menu').click(function (event) {
		$('.burger-menu,.menu__body').toggleClass('_burger-active');
	});
});
...
// Search Page Select OPENING - Main Page
...
// Cheking of Check-boxes - Main Page
...
// Закрытие окна через кнопку Esc
